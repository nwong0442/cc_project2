...
HIT_URL = "https://nwong0442.github.io"  # Provide the URL that you want workers to sent sent to complete you task
...
TITLE = 'Count the number of recognizable faces in the image.'
# Description of the HIT that workers will see when deciding to accept it or not
DESCRIPTION = 'Count how many recognizable faces you see in each of the seven images. A face is recognizable if you can see at least half of the front of the face.'
